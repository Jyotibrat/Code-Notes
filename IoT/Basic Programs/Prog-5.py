...
def blink(t): L1.toggle()  #function which is toggling the On-board LED
def blink1(t): L2.toggle()  #function which is toggling the On-Kit LED (GPIO2)

tim.init(freq=1, mode=Timer.PERIODIC, callback=blink)
tim1.init(period=50, mode=Timer.PERIODIC, callback=blink1)
